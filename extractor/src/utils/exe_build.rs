...
pub const EXE_PATH: &str = "FF8.exe";

// file offset + IMAGE_BASE = virtual address; the data the stages read sits in the flat-mapped
...
// Every offset read from the exe is a v1.2 file offset, matching ida.md. v1.0 holds the same data
// a little further along, by a shift that is constant within each of these v1.2 ranges.
