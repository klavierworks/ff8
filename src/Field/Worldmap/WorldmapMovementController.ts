...
class WorldmapMeshController extends WalkmeshMovementController {
  ...
  public getColorAtUv(uv: { x: number; y: number }): null | Uint8ClampedArray<ArrayBuffer> {
  ...
  public getNextPositionOnWalkmesh(currentPosition: Vector3, moveDirection: Vector3, moveDistance: number): Vector3 {
  ...
  public getPositionOnWalkmesh(position: Vector3): null | Vector3 {
  ...
  public getTriangleForPosition(): null | number {
    return -1
  }
