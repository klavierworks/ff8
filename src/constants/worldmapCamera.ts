import { DRAW_DISTANCE } from '../modules/worldmap/constants'
...
export const WORLDMAP_CAMERA_FAR_PSX = 32768 * DRAW_DISTANCE
...
export const WORLDMAP_CURVATURE_START_DEFAULT = 5216 * DRAW_DISTANCE
export const WORLDMAP_CURVATURE_START_RAGNAROK = 6144 * DRAW_DISTANCE
export const WORLDMAP_CURVATURE_START_RETARGET_STEP = 128 * DRAW_DISTANCE
export const WORLDMAP_CURVATURE_MAX_DEPTH = 65535 * DRAW_DISTANCE
export const WORLDMAP_CURVATURE_FIXED_POINT_ONE = 4096 * DRAW_DISTANCE
export const WORLDMAP_CURVATURE_DEPTH_DIVISOR = 4
export const WORLDMAP_CURVATURE_DROP_DIVISOR = 64 * DRAW_DISTANCE

// ─── Worldmap camera: distance fog ───
export const WORLDMAP_FOG_START_DEFAULT = 1896 * DRAW_DISTANCE
export const WORLDMAP_FOG_START_RAGNAROK = 2996 * DRAW_DISTANCE
