...
Command: npx gltfjsx@6.5.3 ./optimized/base/models/p079.gltf --types --keepgroups --exportdefault --output=./gltf/p079.tsx 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    p079_mesh_0: THREE.SkinnedMesh
    bone_0: THREE.Bone
  }
  materials: {
    p079_mesh_0_texture_0: THREE.MeshStandardMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function p079(
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="p079_mesh_0"
          geometry={nodes.p079_mesh_0.geometry}
          material={materials.p079_mesh_0_texture_0}
          skeleton={nodes.p079_mesh_0.skeleton}
        />
      </group>
    </group>
  )
