...
Command: npx gltfjsx@6.5.3 ./optimized/base/models/o051.gltf --types --keepgroups --exportdefault --output=./gltf/o051.tsx 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    o051_mesh_0: THREE.SkinnedMesh
    bone_0: THREE.Bone
  }
  materials: {
    o051_mesh_0_texture_0: THREE.MeshStandardMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function o051(
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="o051_mesh_0"
          geometry={nodes.o051_mesh_0.geometry}
          material={materials.o051_mesh_0_texture_0}
          skeleton={nodes.o051_mesh_0.skeleton}
        />
      </group>
    </group>
  )
