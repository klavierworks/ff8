...
Command: npx gltfjsx@6.5.3 ./optimized/base/models/p027.gltf --types --keepgroups --exportdefault --output=./gltf/p027.tsx 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    p027_mesh_0: THREE.SkinnedMesh
    bone_0: THREE.Bone
  }
  materials: {
    p027_mesh_0_texture_0: THREE.MeshStandardMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function p027(
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="p027_mesh_0"
          geometry={nodes.p027_mesh_0.geometry}
          material={materials.p027_mesh_0_texture_0}
          skeleton={nodes.p027_mesh_0.skeleton}
        />
      </group>
    </group>
  )
