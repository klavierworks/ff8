...
Command: npx gltfjsx@6.5.3 ./optimized/base/models/o176.gltf --types --keepgroups --exportdefault --output=./gltf/o176.tsx 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    o176_mesh_0: THREE.SkinnedMesh
    bone_0: THREE.Bone
  }
  materials: {
    o176_mesh_0_texture_0: THREE.MeshStandardMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function o176(
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="o176_mesh_0"
          geometry={nodes.o176_mesh_0.geometry}
          material={materials.o176_mesh_0_texture_0}
          skeleton={nodes.o176_mesh_0.skeleton}
        />
      </group>
    </group>
  )
