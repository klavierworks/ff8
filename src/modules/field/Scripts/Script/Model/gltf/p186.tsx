...
Command: npx gltfjsx@6.5.3 ./optimized/base/models/p186.gltf --types --keepgroups --exportdefault --output=./gltf/p186.tsx 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    p186_mesh_0: THREE.SkinnedMesh
    bone_0: THREE.Bone
  }
  materials: {
    p186_mesh_0_texture_0: THREE.MeshStandardMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function p186(
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="p186_mesh_0"
          geometry={nodes.p186_mesh_0.geometry}
          material={materials.p186_mesh_0_texture_0}
          skeleton={nodes.p186_mesh_0.skeleton}
        />
      </group>
    </group>
  )
