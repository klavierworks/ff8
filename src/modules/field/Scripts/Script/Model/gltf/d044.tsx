...
Command: npx gltfjsx@6.5.3 ./optimized/base/models/d044.gltf --types --keepgroups --exportdefault --output=./gltf/d044.tsx 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    d044_mesh_0: THREE.SkinnedMesh
    bone_0: THREE.Bone
  }
  materials: {
    d044_mesh_0_texture_0: THREE.MeshStandardMaterial
  }
  animations: GLTFAction[]
}

export default React.forwardRef(function d044(
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <skinnedMesh
          name="d044_mesh_0"
          geometry={nodes.d044_mesh_0.geometry}
          material={materials.d044_mesh_0_texture_0}
          skeleton={nodes.d044_mesh_0.skeleton}
        />
      </group>
    </group>
  )
