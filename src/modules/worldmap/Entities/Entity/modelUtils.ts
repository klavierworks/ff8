...
export type ModelReference = { index: number; kind: 'wmset' } | { kind: 'charaone'; sectionIndex: number }
...
const getCharaoneModel = (typeCode: number): ModelReference | undefined =>
  typeCode >= 0 && typeCode < CHARAONE_SECTION_COUNT ? { kind: 'charaone', sectionIndex: typeCode } : undefined
